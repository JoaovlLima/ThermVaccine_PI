...
import com.thermvaccine.controller.ConsoleUtils;
...
public class FluxoLogistico {
    ...
    public void start(UserLogistica user){
        ...
        System.out.println("3-) Escolher Caixa");
        System.out.println("4-) Cadastrar Transporte");
        System.out.println("5-) Escolher Transporte");
